...
export interface backendInterface {
    ...
    __menu(): Promise<Array<MenuItem>>;
    __whyChooseUs(): Promise<Array<WhyChooseUsFeature>>;
...
export class Backend implements backendInterface {
    ...
    async __menu(): Promise<Array<MenuItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.__menu();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async __whyChooseUs(): Promise<Array<WhyChooseUsFeature>> {
        if (this.processError) {
            try {
                const result = await this.actor.__whyChooseUs();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getWhyChooseUs(): Promise<Array<WhyChooseUsFeature>> {
        if (this.processError) {
            try {
